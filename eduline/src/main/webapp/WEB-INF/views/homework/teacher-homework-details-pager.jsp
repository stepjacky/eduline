           ...
           <td >         
            <c:choose>
              <c:when test="${type=='unscored' }">
                <a class="btn btn-info btn-xs scoreItem"  href="/homework/teacher/homework/card/${item.id}?workId=${workId }" >       
        		     <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                </a>
              </c:when>
              <c:when test="${type=='scored' }">
                <a class="btn btn-info btn-xs scoreItem"  href="/homework/forall/card/scored/${item.id}?workId=${workId }" >       
        		     <i class="fa fa-check-circle-o" aria-hidden="true"></i>
                </a>
              </c:when>
              <c:otherwise>
