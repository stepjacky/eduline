    ...
    <div class="panel-body">
        <form class="form-inline" action="/violates/query/0" method="post">
            ...
            <div class="form-group">
                <label >学生姓名</label> <input type="text"
        ...
        <form class="form-inline" action="/violates/query/0" method="post">
            ...
            <div class="form-group">
                <label >老师姓名</label> <input type="text"
                                                             class="form-control" name="teacherName"
                                                             placeholder="老师姓名">
            </div>
            <input class="query" name="query" type="hidden">
            <button type="button" class="btn btn-primary querybtn">
                <span class="glyphicon glyphicon-search"></span>
            </button>
        </form>
        ...
        <form class="form-inline" action="/violates/currentgrade/0"
            ...
            <div class="form-group">
                <label >所处学年</label> <select name="eduyear"
                                                              class="form-control">
                <c:forEach var="g" begin="2015" end="2020">
            ...
            <button type="button" class="btn btn-primary querybtn2">
                <span class="glyphicon glyphicon-search"></span>
            </button>
        </form>
        <hr>
        <a href="/violates/chart/monthly/${atNow.year}/${atNow.monthValue}">${atNow.year}年${atNow.monthValue}月各年级图表</a>
    </div>
</div>
