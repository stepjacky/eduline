...
<div class="table-responsive">
      <table
        ...
        <c:forEach items="${pager.dataList}" var="item">
            <tr>
                <td><a class="btn btn-primary btn-xs action-href-nav"
...
<span class="label label-default">学号/姓名</span>
<input id="student" class="form-control" placeholder="学号/姓名">
<div id="dataArea"></div>
    ...
    <div class="table-responsive">
        <form id="violates_form">
            <table class="table table-hover table-condensed table-bordered table-striped">
                ...
                <tr>
                    <td>学生学号</td>
                    <td><input type='text' id='student' name='student' class='form-control' readonly
                               value="{{student}}"></td>
                </tr>
                <tr>
                    <td>学生姓名</td>
                    <td><input type='text' name='studentName' class='form-control' readonly value="{{studentName}}">
                    </td>
                </tr>
                <tr>
                    <td>情况说明</td>
